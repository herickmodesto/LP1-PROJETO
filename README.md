...
Antes de tudo gostaria de deixar os link do [repositório do github](https://github.com/herickmodesto/LP1-PROJETO/), e da [documentação do projeto](https://herickmodesto.github.io/LP1-PROJETO/) para consultas mais detalhadas.
## Discente
| Nome        | Matricula   |
| ----------- | ----------- |
